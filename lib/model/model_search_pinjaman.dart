...
class ModelSearchPinjaman {
  ...
  ModelSearchPinjaman.fromJson(Map<String, dynamic> json) {
    data = json["data"] == null ? null : (json["data"] as List).map((e) => DataView.fromJson(e)).toList();
    error = json["error"];
...
class DataView {
  ...
  DataView({this.angsuran, this.cBranch, this.cDocno, this.cStatus,
    this.cdocno, this.cjaminan, this.cnote, this.jasa, this.mBadmin,
    this.mNilaiPinjaman, this.mPokok, this.mSisa1, this.mSisa2,
    this.mValue1, this.mValue2, this.nJasaPinjaman, this.pinjaman, this.tenor, this.tgl});

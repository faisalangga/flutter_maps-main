...
import 'package:koperasimobile/model/model_profil.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Account',
          style: TextConstant.medium.copyWith(color: Colors.black87, fontSize: 18),
        ),
        elevation: 0.5,
        centerTitle: true,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            title,
            style: TextConstant.medium.copyWith(color: Colors.black87, fontSize: 15),
          ),
        ],
      ),
    );

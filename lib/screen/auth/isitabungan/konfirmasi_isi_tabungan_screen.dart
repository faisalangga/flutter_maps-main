...
class _ConfirmPageState extends State<ConfirmPage> {
  ...
  Future<DataRekening> fetchRekening() async {
    ...
    try {
      ...
      API.basePostGolang(ConstUrl.rekening, post, header, true, (result, error) {
        if (error != null) {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                  Clipboard.setData(ClipboardData(text: '$ininorex'));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Clipboard.setData(ClipboardData(text: rupiah(nominal)));
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Teks berhasil disalin'),
                              ),
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                            'Jika Sudah Transfer, Unggah Bukti Transfer Disini',
                            style: TextStyle(color: Colors.grey.shade700)),
                        SizedBox(height: 10),
                        GestureDetector(
                  ...
                  ButtonGreenWidget(
                    text: 'Transfer',
                    onClick: () => controller.validationTabungan(
                        value : _getValue(),
                        context: context,
                        callback: (result, error) {
                          if (result != null && result['error'] != true) {
                            ...
                            DocnoTabModel response = DocnoTabModel.fromJson(result);
                            setState(() {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  ...
                                  // builder: (context) => SubMenuTabungan(),
                                    builder: (context) => CetakTabunganPage(docno: docno,value: _getValue() ),
                                ));
                            }
                            if (error != null) {
                              DialogConstant.alertError('Deposit Gagal, Hubungi IT');
                            }
                          }
                        ),
                  ),
